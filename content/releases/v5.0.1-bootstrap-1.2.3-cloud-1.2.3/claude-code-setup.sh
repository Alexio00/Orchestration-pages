...
Новые/неизвестные версии не понижай. Повреждённые, вложенные или неоднозначные маркеры требуют решения PO. Старый однозначный блок с ядром General 5 можно заменить; немаркированный полный протокол не дублируй — предложи миграцию.
